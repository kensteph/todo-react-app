...
- **Edit todos**
- **Delete todos**
- **Preserve todos in the browser's local storage**
...
## 💻 Todos <a name="vgs-presentation"></a>
...
```sh
  cd my-folder
  git clone git@github.com:kensteph/todo-react-exercice.git
```
